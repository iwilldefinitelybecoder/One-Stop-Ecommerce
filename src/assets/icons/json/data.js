...
export const crossMarkGif = crossMark;
export const heartMarkGif = heartMark;
export const errorCheckMarkGif = errorCheckMark;
export const checkMark2Gif = checkMark2;