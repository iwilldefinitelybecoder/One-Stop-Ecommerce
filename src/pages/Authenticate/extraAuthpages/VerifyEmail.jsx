...
const VerifyEmail = () => {
  ...
  const handelResendVerificationLink = async () => {
    setIsPending(true);
    const data = await resendVerificationEmail(status);
    setResponse(data?.message);
    setIsPending(false);
  }
    ...
    <>
      <div className="w-full h-[100vh] py-5 bg-main-bg flex justify-center items-center ">
        <div className=" bg-white rounded-xl shadow-xl">
          ...
          <div
            className="login-main-cntr w-[500px] py-8 px-3 bg-white space-y-5 justify-center items-center rounded-xl  z-50 "
  ...
  return (
    <>
      ...
      <p className=" text-center font-normal">
        You have Entered <span className="font-semibold text-lg">{data.email}</span>{" "}
